# Vérification de la publication — 25 septembre 2026

- 29 pages HTML vérifiées : 14 françaises, 14 anglaises et une page 404.
...
- Les anciennes pages `merci.html` et `en/thank-you.html`, devenues inutilisées, ont été supprimées.

Résultat du contrôle structurel : **0 problème détecté**.

Ces vérifications ne constituent pas un audit complet de conformité RGAA/WCAG ni une validation des contenus scientifiques. Les vérifications humaines, notamment avec lecteurs d’écran et pour les PDF, restent nécessaires.
